...
public class Join extends Operator {
    ...
    public String getJoinField1Name() {
        // some code goes here
        return this.children[0].getTupleDesc().getFieldName(this.predicate.getField1());
    }
    ...
    public String getJoinField2Name() {
        // some code goes here
        return this.children[1].getTupleDesc().getFieldName(this.predicate.getField2());
    }
    ...
    public void open() throws DbException, NoSuchElementException,
        ...
        // some code goes here
        for (DbIterator child : this.children) {
            child.open();
        }
        super.open();
    }
